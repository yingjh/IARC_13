...
"""
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_struct_d.pack(self.tf_pub_rate))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_id.pack(_x.delay, _x.position_scale))
      _x = self.noise_type
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_10d.pack(_x.sigma_roll_pitch, _x.sigma_yaw, _x.sigma_xy, _x.sigma_z, _x.random_walk_k_xy, _x.random_walk_k_z, _x.random_walk_sigma_xy, _x.random_walk_sigma_z, _x.random_walk_tau_xy, _x.random_walk_tau_z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.tf_pub_rate,) = _struct_d.unpack(str[start:end])
      start = end
      end += 4
      ...
      if python3:
        self.tf_ref_frame = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.tf_frame_in = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.tf_frame_out = str[start:end].decode('utf-8')
      else:
        self.tf_frame_out = str[start:end]
      _x = self
      start = end
      end += 12
      (_x.delay, _x.position_scale,) = _struct_id.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.noise_type = str[start:end].decode('utf-8')
      else:
        self.noise_type = str[start:end]
      _x = self
      start = end
      end += 80
      (_x.sigma_roll_pitch, _x.sigma_yaw, _x.sigma_xy, _x.sigma_z, _x.random_walk_k_xy, _x.random_walk_k_z, _x.random_walk_sigma_xy, _x.random_walk_sigma_z, _x.random_walk_tau_xy, _x.random_walk_tau_z,) = _struct_10d.unpack(str[start:end])
      return self
