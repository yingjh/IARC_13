/**
  ***************************************************************************************
  * @file    SRUKF_twoLinear.h
  * @author  YANG Shuo
  * @version V1.0.0
  * @date    29-May-2014
  * @brief   This file is a implementation of square-root UKF, depends on linear algebra
  *          C++ library Eigen3. It has two set of linear measurement functions  
  ***************************************************************************************
  */
#ifndef _SRUKF_H
#define _SRUKF_H
...
*/
        ...
        // the correct step is similar to kalman filter correct step, where the measurement function 
        // is linear.
        void correct(const MatrixXf& H, const VectorXf& z_t);
