...
class OpenRadar
{
	...
	private:
		...
		static const int skip_bin_idx = 0; 
		...
		static const int clear_thres = 501;	//100
		static const int block_thres = 501;	//300
		...
		static const float my_range_max = 1 * 1000, my_range_min = 0.2 * 1000;
