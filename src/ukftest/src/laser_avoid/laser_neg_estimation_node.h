...
namespace estimation
{
	...
	typedef boost::shared_ptr<ukftest::laserPoint const> LaserConstPtr;
	...
	private:
		...
		/// callback function for imu data
		void laserCallback(const LaserConstPtr& laser);

		ros::NodeHandle node_;
		ros::Timer timer_;
		ros::Publisher pose_pub_;
		ros::Subscriber imu_sub_, vo_sub_, laser_sub_;
		...
		ros::Time imu_time_, vo_time_, laser_time_;
		ros::Time imu_stamp_, vo_stamp_,laser_stamp_, filter_stamp_;
		ros::Time imu_init_stamp_, vo_init_stamp_,laser_init_stamp_;

		bool imu_active_, vo_active_, laser_active_;
		bool imu_used_, vo_used_, laser_used_;
		bool imu_initializing_, vo_initializing_, laser_initializing_;
		...
		// counters
		unsigned int imu_callback_counter_, vo_callback_counter_, laser_callback_counter_,ukf_sent_counter_;
